...
$(document).ready(function () {
  ...
  if (searchInput !== 0) {
    ...
    window.displayBoxareausuario = -1;
    ...
    var Navigate = function (diff) {
      displayBoxareausuario += diff;
      var oBoxCollection = $(".dropdown-menu-search .nav-item");
      if (displayBoxareausuario >= oBoxCollection.length) displayBoxareausuario = 0;
      if (displayBoxareausuario < 0) displayBoxareausuario = oBoxCollection.length - 1;
      var cssClass = "active";
      oBoxCollection
        .removeClass(cssClass)
        .eq(displayBoxareausuario)
        .addClass(cssClass);
    };
  }
